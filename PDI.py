...
try:
	...
	print W + ' '
	print ('I D I').center(44)
	print ' '
	print "[!] No se pueden importar las solicitudes del módulo'\n"
	sys.exit()
####################################################################
...
def info_ga():
	...
	print '''
     %sCOMANDO                      DESCRIPCION%s
  -------------       -------------------------------------

   get_data           obteniendo los datos de todos los amigos
...
def get(data):
	...
	try:
		...
		b.close()
		print '[*] generar token de acceso con éxito'
		print '[*] Su token de acceso se almacena en una cookie/token.log'
		exit()
	except KeyError:
		print '[!] No se pudo generar el token de acceso '
		print '[!] Verifique su conexión / correo electrónico o contraseña '
		...
		main()
def id():
	print '[*] inicie sesión en su cuenta de facebook         ';id = raw_input('[?] Nombre de usuario : ');pwd = getpass.getpass('[?] Contraseña : ');API_SECRET = '62f8ce9f74b12f84c123cc23437a4a32';data = {"api_key":"882a8490361da98702bf97a021ddc14d","credentials_type":"password","email":id,"format":"JSON", "generate_machine_id":"1","generate_session_cookies":"1","locale":"en_US","method":"auth.login","password":pwd,"return_ssl_resources":"0","v":"1.0"};sig = 'api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail='+id+'format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en_USmethod=auth.loginpassword='+pwd+'return_ssl_resources=0v=1.0'+API_SECRET
	x = hashlib.new('md5')
        x.update(sig)
